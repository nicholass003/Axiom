...
namespace Nicholass003\Axiom\Codec\v859\Serializer\Camera\Instruction;
...
class CameraSplineInstructionSerializer implements ForkableInterface{
    ...
    public function read(ByteBufferReader $in) : CameraSplineInstruction{
        ...
        $progressKeyFrames = CodecHelper::readList($in, fn($in) => new CameraProgressOption(LE::readFloat($in), LE::readFloat($in)));
