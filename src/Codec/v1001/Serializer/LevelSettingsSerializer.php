...
namespace Nicholass003\Axiom\Codec\v1001\Serializer;
...
use Nicholass003\Axiom\Codec\v944\Serializer\LevelSettingsSerializer as V944LevelSettingsSerializer;
...
class LevelSettingsSerializer extends V944LevelSettingsSerializer{
    ...
    public function read(ByteBufferReader $in) : LevelSettingsData{
        return new LevelSettingsData(
            ...
            allowAnonymousBlockDropsInEditorWorlds: CodecHelper::readBool($in)
        );
    }
    ...
    public function write(ByteBufferWriter $out, LevelSettingsData $d) : void{
        ...
        VarInt::writeSignedInt($out, $d->serverEditorConnectionPolicy);
        CodecHelper::writeBool($out, $d->allowAnonymousBlockDropsInEditorWorlds);
    }
}
